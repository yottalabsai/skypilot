...
class MulticloudResourcesClient(object):
    ...
    def list_multicloud_resources(self, subscription_service_name, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/multicloud/list_multicloud_resources.py.html>`__ to see an example of how to use list_multicloud_resources API.
        """
