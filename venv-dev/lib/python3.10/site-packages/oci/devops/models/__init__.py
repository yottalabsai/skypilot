...
from .commit_message_settings import CommitMessageSettings
...
from .repository_path_commit_details import RepositoryPathCommitDetails
...
devops_type_mapping = {
    ...
    "RepositoryPathCommitDetails": RepositoryPathCommitDetails,
