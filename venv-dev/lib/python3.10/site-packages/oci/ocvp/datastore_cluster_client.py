...
class DatastoreClusterClient(object):
    ...
    def add_datastore_to_datastore_cluster(self, datastore_cluster_id, add_datastore_to_datastore_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/add_datastore_to_datastore_cluster.py.html>`__ to see an example of how to use add_datastore_to_datastore_cluster API.
        """
    ...
    def attach_datastore_cluster_to_cluster(self, datastore_cluster_id, attach_datastore_cluster_to_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/attach_datastore_cluster_to_cluster.py.html>`__ to see an example of how to use attach_datastore_cluster_to_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['datastoreClusterId']
    ...
    def attach_datastore_cluster_to_esxi_host(self, datastore_cluster_id, attach_datastore_cluster_to_esxi_host_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/attach_datastore_cluster_to_esxi_host.py.html>`__ to see an example of how to use attach_datastore_cluster_to_esxi_host API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['datastoreClusterId']
    ...
    def change_datastore_cluster_compartment(self, datastore_cluster_id, change_datastore_cluster_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/change_datastore_cluster_compartment.py.html>`__ to see an example of how to use change_datastore_cluster_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['datastoreClusterId']
    ...
    def create_datastore_cluster(self, create_datastore_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/create_datastore_cluster.py.html>`__ to see an example of how to use create_datastore_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_datastore_cluster(self, datastore_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/delete_datastore_cluster.py.html>`__ to see an example of how to use delete_datastore_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['datastoreClusterId']
    ...
    def detach_datastore_cluster_from_cluster(self, datastore_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/detach_datastore_cluster_from_cluster.py.html>`__ to see an example of how to use detach_datastore_cluster_from_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['datastoreClusterId']
    ...
    def detach_datastore_cluster_from_esxi_host(self, datastore_cluster_id, detach_datastore_cluster_from_esxi_host_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/detach_datastore_cluster_from_esxi_host.py.html>`__ to see an example of how to use detach_datastore_cluster_from_esxi_host API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['datastoreClusterId']
    ...
    def get_datastore_cluster(self, datastore_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/get_datastore_cluster.py.html>`__ to see an example of how to use get_datastore_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['datastoreClusterId']
        resource_path = "/datastoreClusters/{datastoreClusterId}"
    ...
    def list_datastore_clusters(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/list_datastore_clusters.py.html>`__ to see an example of how to use list_datastore_clusters API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def remove_datastore_from_datastore_cluster(self, datastore_cluster_id, remove_datastore_from_datastore_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/remove_datastore_from_datastore_cluster.py.html>`__ to see an example of how to use remove_datastore_from_datastore_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['datastoreClusterId']
    ...
    def update_datastore_cluster(self, datastore_cluster_id, update_datastore_cluster_details, **kwargs):
        ...
        **Important:** Updating a Datastore Cluster affects only certain attributes in the `Datastore Cluster`
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.165.0/ocvp/update_datastore_cluster.py.html>`__ to see an example of how to use update_datastore_cluster API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['datastoreClusterId']
        resource_path = "/datastoreClusters/{datastoreClusterId}"
