...
class ResourcePoolSummary(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param pool_storage_size_in_tbs:
            The value to assign to the pool_storage_size_in_tbs property of this ResourcePoolSummary.
        :type pool_storage_size_in_tbs: int

        :param available_storage_capacity_in_tbs:
            The value to assign to the available_storage_capacity_in_tbs property of this ResourcePoolSummary.
        :type available_storage_capacity_in_tbs: float
        ...
        self._pool_storage_size_in_tbs = None
        self._available_storage_capacity_in_tbs = None
    ...
    @property
    def pool_storage_size_in_tbs(self):
        """
        Gets the pool_storage_size_in_tbs of this ResourcePoolSummary.
        Resource pool storage size in TBs.


        :return: The pool_storage_size_in_tbs of this ResourcePoolSummary.
        :rtype: int
        """
        return self._pool_storage_size_in_tbs

    @pool_storage_size_in_tbs.setter
    def pool_storage_size_in_tbs(self, pool_storage_size_in_tbs):
        """
        Sets the pool_storage_size_in_tbs of this ResourcePoolSummary.
        Resource pool storage size in TBs.


        :param pool_storage_size_in_tbs: The pool_storage_size_in_tbs of this ResourcePoolSummary.
        :type: int
        """
        self._pool_storage_size_in_tbs = pool_storage_size_in_tbs

    @property
    def available_storage_capacity_in_tbs(self):
        """
        Gets the available_storage_capacity_in_tbs of this ResourcePoolSummary.
        ...
        :return: The available_storage_capacity_in_tbs of this ResourcePoolSummary.
        :rtype: float
        """
        return self._available_storage_capacity_in_tbs

    @available_storage_capacity_in_tbs.setter
    def available_storage_capacity_in_tbs(self, available_storage_capacity_in_tbs):
        """
        Sets the available_storage_capacity_in_tbs of this ResourcePoolSummary.
        Available storage capacity (in TB) that can be used for adding new members or scaling existing members in a dedicated elastic pool.


        :param available_storage_capacity_in_tbs: The available_storage_capacity_in_tbs of this ResourcePoolSummary.
        :type: float
        """
        self._available_storage_capacity_in_tbs = available_storage_capacity_in_tbs
