...
from nebius.api.nebius.vpc.v1 import route_pb2 as _route_pb2
...
class GetRouteByNameRequest(_message.Message):
...
class ListRoutesResponse(_message.Message):
    ...
    items: _containers.RepeatedCompositeFieldContainer[_route_pb2.Route]
    next_page_token: str
    def __init__(self, items: _Optional[_Iterable[_Union[_route_pb2.Route, _Mapping]]] = ..., next_page_token: _Optional[str] = ...) -> None: ...
...
class CreateRouteRequest(_message.Message):
    ...
    spec: _route_pb2.RouteSpec
    def __init__(self, metadata: _Optional[_Union[_metadata_pb2.ResourceMetadata, _Mapping]] = ..., spec: _Optional[_Union[_route_pb2.RouteSpec, _Mapping]] = ...) -> None: ...
